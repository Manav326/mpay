...
export default function LandingPage(){
  ...
  return <main className="landing">
    ...
    <footer className="landing-footer"><Brand/><span>© {new Date().getFullYear()} mPay. Digital payments, made clearer.</span><div><a href="/admin/login">Admin portal</a><a href="/login">Login</a></div></footer>
  </main>;
}